...
namespace AndreasBueckle.Assets.Scripts.Visualization
{
    ...
    public class Visualizer : MonoBehaviour
    {
        ...
        /// <returns>A list of GameObjects that contains edges</returns>
        ...
        /// </summary>
        /// <param name="objects">GameObjects whose transform parent to set</param>
        /// <param name="parent">Desired transform parent</param>
        ...
        /// </summary>
        /// <param name="edges">All the edge structs from the DataReader</param>
        ...
        /// </summary>
        /// <param name="nodes">List of GameObjects for nodes</param>
        /// <param name="edges">List of GameObjects for edges</param>
        ...
        /// </summary>
        /// <param name="layout">Desired layout</param>
        /// <param name="objects">List of GameObjects for nodes to be laid out</param>
        ...
        /// </summary>
        /// <param name="nodes">List of GameObjects for nodes to stack</param>
        ...
        /// </summary>
        /// <param name="originalLat">Raw latitude</param>
        /// <param name="originalLon">Raw longitude</param>
        ...
        /// </summary>
        /// <param name="layout">Desired layout for this set of nodes</param>
